...
| red_ref : forall G m l t (v : Value _),
    Is_fresh_label l m ->
    T[ G |- v ::: t ] ->
    red (Ref v) m (Lab l t) ((l,v) :: m)%list

| red_deref : forall m l t v,
    Lookup l m v ->
    red (Deref (Lab l t)) m v m

| red_assign : forall m m' l t v,
    Assignment l v m m' ->
    red (Assign (Lab l t) v) m U_val m'
